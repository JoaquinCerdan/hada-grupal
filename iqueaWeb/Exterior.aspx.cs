...
namespace iqueaWeb
{
    public partial class Exterior : System.Web.UI.Page
    {
        ...
        void Load_GridData()
        {
            ...
            {
                conn.Open();
                SqlDataAdapter sqa = new SqlDataAdapter("Select * From [dbo].[Articulo] inner join [dbo].[Categoria] where Articulo.IdCategoria=Categoria.id and Categoria.Nombre='exterior'", conn);
