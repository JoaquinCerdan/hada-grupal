...
namespace iqueaWeb
{
    public partial class Exterior : System.Web.UI.Page
    {
        ...
        // Se rellena el gridview con los datos de la secuencia que se escribe en este método
        void Load_GridData()
        {
            try
            {
        ...
        //Cuando se selecciona el articulo en el gridview te lleva a su pagina
