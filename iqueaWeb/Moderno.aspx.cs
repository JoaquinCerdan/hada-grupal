...
namespace iqueaWeb
{
    public partial class Moderno : System.Web.UI.Page
    {
        ...
        void Load_GridData()
        {
            ...
            {
                conn.Open();
                SqlDataAdapter sqa = new SqlDataAdapter("Select * From [dbo].[Articulo] inner join [dbo].[Categoria] where Articulo.id=Categoria.articulo_id and Categoria.Nombre='moderno'", conn);
